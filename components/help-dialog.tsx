      ...
      <DialogContent className="sm:max-w-[625px] dark:bg-gray-900 dark:text-white rounded-xl shadow-lg">
        ...
        <Tabs defaultValue="about" className="mt-4">
          <div className="flex justify-center">
            <TabsList
              className="bg-gray-100 dark:bg-gray-800 rounded-lg mb-4 animate-in fade-in-50 duration-300"
          ...
          <TabsContent
            value="about"
            className="space-y-4 mt-4 animate-in fade-in-50 slide-in-from-bottom-5 duration-300"
            style={{ animationDelay: "300ms" }}
          >
            <h3 className="font-semibold text-[#003A6E] dark:text-blue-300 text-center">Why This Exists</h3>
            <p className="mt-2">
              I built this tool to help QUT students view and plan their timetables without suffering through the mess
              that is QUT Allocate+. Use it however works best for you — hope it makes your life just a little easier!
              <br />
              <br />- Daniel 😃
            </p>
          </TabsContent>
          ...
          >
            ...
            <p>
              ...
              way I want. This tool lets you build your dream timetable by selecting the exact class times that work for
              you.
            </p>
            <h3 className="font-semibold text-[#003A6E] dark:text-blue-300 mt-4 text-center">
            ...
            <p className="italic text-gray-600 dark:text-gray-400 mt-2">
              The app will warn you about time conflicts between classes, but you can still add them if you want.
            </p>
          </TabsContent>
        </Tabs>
      </DialogContent>
